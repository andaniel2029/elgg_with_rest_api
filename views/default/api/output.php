...
<div id="api_result">
    <table width="100%">
        ...
        <tr>
            <td width="100" valign="top"><b>Result:</b></td>
            <td>
        ...
        <?php if ($export->pam) { ?>
        <tr>
            <td width="100" valign="top"><b>PAM:</b></td>
            <td>
                <pre><?php print_r($export->pam); ?></pre>
            </td>
        </tr>
        <?php } ?>
        ...
        <tr>
            <td width="100" valign="top"><b>Runtime:</b></td>
            <td>
                <pre><?php print_r($export->runtime_errors); ?></pre>
            </td>
        </tr>
        <?php } ?>
    </table>
